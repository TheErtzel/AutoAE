...
SCREEN_ENTITY_OFFSETS: List[List[int]] = [
    0x1C0,  0x88,  0x150,  0x18,  0xE0,  0x1A8,  0x138,  0x0,  0xC8,  0x190, 0x134, 0x148,
    0x58, 0x120,  0x1E8,  0xB0,  0x178,  0x140,  0x8,  0xD0,  0x198,  0x60, 0x30, 0xF8, 0xC0, 0x188, 0x50, 0x118, 0x1E0, 0xA8, 0x170, 0x38, 0x100,
    0x1C8, 0x90, 0x158, 0x20, 0xE8, 0x1B0, 0x78, 0x40, 0x108, 0x1D0, 0x68, 0x130, 0x1F8, 0x88, 0x18, 0xE0, 0x1A8, 0x70, 0x1D8,  0xA0, 0x168, 0x50, 0x98, 0x110, 0x1B8,
    0x1A0, 0x1C0, 0x1F0, 0x1FC, 0x4C, 0x5C, 0x48, 0x40, 0x24, 0x28, 0x14, 0x10, 0xB8, 0xD8, 0x128, 0x160, 0x80
]
SCREEN_HEX: List[int] = [0x0, 0x200]
